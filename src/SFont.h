...
*  in your program. 							*
*									*
*  Modified by Jason Wood <jasonwood@blueyonder.co.uk>			*
*  	- Changed char *text parameters to const char *text		*
************************************************************************/
...
int TextWidth2(SFont_FontInfo *Font, const char *text);

// Blits a string to with centered x position
void XCenteredString (SDL_Surface *Surface, int y, const char *text);
void XCenteredString2(SDL_Surface *Surface, SFont_FontInfo *Font, int y, const char *text);
